coordinateTransformationsModule.controller("coordinateTransformationsController", function ($rootScope, $scope, $http, scopeService) {
    ...
    $scope.transform = function () {
        ...
        var id = $("#coordinateTransformationsCombo").data("kendoDropDownList").value();

        var name = $("#coordinateTransformationsCombo").data("kendoDropDownList").text();
    ...
    $scope.zoneOptions = {
        ...
        index:39,
        change: function () {
            var id = $("#zoneCombo").data("kendoDropDownList").value();
